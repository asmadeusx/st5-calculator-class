...
const btnsNum = document.querySelectorAll('.buttons__num');
const btnNumCol1 = document.querySelector('.num__col1');
class Button {
    constructor(parent, column, number, innertext, classes) {
        this.parent = parent;
        this.column = column;
        this.number = number;
