...
var btnsNum = document.querySelectorAll('.buttons__num');
var btnNumCol1 = document.querySelector('.num__col1');

var Button = function Button(parent, column, number, innertext, classes) {
...
console.log(btnsNum); // //#region Получение элементов
// // Дисплей
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "17677" + '/');
